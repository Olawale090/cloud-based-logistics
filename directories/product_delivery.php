    ...
    <form action="" method="post" class="product_delivery_registration">
        ...
        <div class="p_quantity_delivery_number">
            ...
            <div class="product_quantity">
                ...
                <input type="text" placeholder="Please enter product quantity" name="product_quantity" class="product_quantity" >
            ...
            <div class="product_delivery_number">
                ...
                <input type="text" placeholder="Please enter product delivery number" name="product_delivery_number" class="product_delivery_number">
