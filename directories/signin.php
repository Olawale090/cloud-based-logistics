...
<body>
    ...
    <form class="signin_form" action="" method="get">
        ...
        <input type="text" name="user_signin_email" placeholder = "Email here" id="" class="signin_email">
        
        <label for="Email">Password</label>
        <input type="text" name="user_signin_password" placeholder = "Password here" id="" class="signin_password">
        ...
        <div class="sign_dir"> Don't have an account? 
            ...
            <a href="signup.html" class="sign_up_redirect"> Sign up </a>
